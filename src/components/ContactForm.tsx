...
//         {" "}
//         <div className="">
//           <div className="p-4 md:p-[28px] pb-6">
//             <h2 className="text-white text-[18px] md:text-[32px] font-[300] flex-1">
//               Send us a{" "}
...
//                       }}
//                       className={`w-full rounded-[4px] m-1 border px-2 py-[9px] md:px-3 md:py-[7px] text-[#B1B1B1] text-[12px] md:text-[13px] placeholder-[#B1B1B1] focus:outline-none resize-none ${
...
//           <div className="flex justify-center p-4 md:px-[28px]">
//             <button
//               type="submit"
