      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-8">
        ...
        <div className="border border-[#E5E5E533] p-4 md:p-8 rounded-xl">
          ...
          <div className="space-y-5">
            {/* Email */}
            <div className="flex gap-4 items-center bg-gradient-to-b from-neutral-900 to-neutral-950 rounded-lg p-4">
              <Image src={"/envelope.svg"} alt="Icon" width={24} height={24} />
              <div>
                <p className="font-normal text-base">hello@goeffortless.ai</p>
            ...
            >
              ...
              />
              <div>
                <p className="font-normal text-base">+91 91765 44422</p>
          ...
          <div className="space-y-5">
            {[
              ...
              >
                ...
                <p className="font-normal">{social.name}</p>
              </button>
            ))}
          </div>
        </div>
