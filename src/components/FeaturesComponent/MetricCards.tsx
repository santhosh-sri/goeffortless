      ...
      <div className="">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
          {cards.map((card, idx) => (
            ...
            >
              {/* Value */}
              <div className="text-[28px] md:text-[40px] font-medium text-accent">
                {card.value}
              </div>

              {/* Label */}
              <div className="text-content-muted text-base md:text-xl leading-6 font-light border-t border-[#2A2A2A] pt-3">
                {card.label}
              </div>
            </div>
          ))}
