...
const ROICalculator: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className=" bg-[linear-gradient(111.18deg,rgba(255,255,255,0.1)_-28.62%,rgba(255,255,255,0)_104.36%)] rounded-lg p-10 border border-white/10">
      <div className="flex flex-col gap-6 md:gap-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {data.fields.map((field) => (
            <div key={field.id} className="flex flex-col gap-2">
              ...
              <div className="text-[#E4E4E7] bg-[linear-gradient(111.18deg,rgba(255,255,255,0.1)_-28.62%,rgba(255,255,255,0)_104.36%)] w-full rounded px-4 py-4 text-base font-light shadow-md border border-white/10">
                {field.placeholder}
              </div>
            </div>
          ))}
        ...
        <div className="text-center">
          <h2 className="text-2xl font-semibold text-white leading-[31px]">
            {data.title}
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-4 md:gap-6">
          {data.bars.map((bar, i) => (
            <div key={i} className="flex flex-col gap-3">
              <p className="text-base leading-[25px] text-white font-semibold">
                {bar.label}
              </p>

              <div
                className="rounded-lg px-4 py-3 text-white font-medium"
                style={{
        ...
        <div className=" shadow-md border border-white/10 bg-[linear-gradient(111.18deg,rgba(255,255,255,0.1)_-28.62%,rgba(255,255,255,0)_104.36%)] py-10 px-4 rounded-lg flex flex-col gap-4">
          ...
          <p className="text-base font-light text-white text-center">
            You also avoid the{" "}
        ...
        {/* Breakdown */}
        <p className="text-center text-2xl font-semibold text-white leading-[31px]">
          {data.breakdownTitle}
        </p>
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {data.breakdown.map((item, i) => (
              ...
              >
                ...
                <p className="text-[#F08B32] text-2xl font-medium leading-8">
                  {item.value}
                </p>
        ...
        <div className=" shadow-md border border-white/10 rounded-xl p-4 bg-[linear-gradient(111.18deg,rgba(255,255,255,0.1)_-28.62%,rgba(255,255,255,0)_104.36%)]">
          <p className="text-[#F08B32] text-3xl font-medium">
            Total Impact: {data.totalImpact}
          </p>
          <p className="text-[18px] leading-[28px] font-light text-white">
