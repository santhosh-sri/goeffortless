...
const PentCard: React.FC<PentaCard> = ({ title, description, img }) => {
  return (
    <div className="text-content flex flex-col gap-4 md:gap-6 p-[42px] md:p-9 rounded-xl bg-[linear-gradient(111.18deg,rgba(255,255,255,0.1)_-28.62%,rgba(255,255,255,0)_104.36%)] items-center justify-center md:w-[30%]">
      ...
      <div className="flex flex-col gap-4 items-center justify-between text-center">
        ...
        <div className="flex gap-1 items-center cursor-pointer">
          <p className="text-accent text-[20px] font-[300]">Know More</p>
